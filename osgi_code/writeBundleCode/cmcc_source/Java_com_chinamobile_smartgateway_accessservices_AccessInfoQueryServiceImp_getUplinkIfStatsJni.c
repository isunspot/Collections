...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_accessservices_AccessInfoQueryServiceImp_getUplinkIfStatsJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getUplinkIfStats(response);
