...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceInfoQueryServiceImp_getCPUOccupancyRateJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getCPUOccupancyRate(&response);
