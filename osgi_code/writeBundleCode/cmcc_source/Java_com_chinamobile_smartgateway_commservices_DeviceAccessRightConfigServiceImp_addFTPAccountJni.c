...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_addFTPAccountJni
(JNIEnv *env, jobject obj, jstring username, jstring password )
{
	...
	ret = joyme_cmcc_addFTPAccount(&response, usernameStr, passwordStr);
