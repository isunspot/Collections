...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficDetailProcessServiceImp_getHTTPTrafficProcessRuleInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getHTTPTrafficProcessRuleInfo(response);
