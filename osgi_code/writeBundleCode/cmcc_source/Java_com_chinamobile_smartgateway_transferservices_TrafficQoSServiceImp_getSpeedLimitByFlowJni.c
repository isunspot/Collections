...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficQoSServiceImp_getSpeedLimitByFlowJni
(JNIEnv *env, jobject obj, jint flow )
{
	...
	ret = joyme_cmcc_getSpeedLimitByFlow(response, flow);
