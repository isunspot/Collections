...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getLayer3ForwardingStaticConfigInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getLayer3ForwardingStaticConfigInfo(response);
