...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getIPv6Layer3ForwardingStaticConfigInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getIPv6Layer3ForwardingStaticConfigInfo(response);
