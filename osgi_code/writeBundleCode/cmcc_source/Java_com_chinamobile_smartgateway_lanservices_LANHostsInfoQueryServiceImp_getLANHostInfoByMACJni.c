...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_LANHostsInfoQueryServiceImp_getLANHostInfoByMACJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_getLANHostInfoByMAC(response, hostMACList, hostMACNum);
