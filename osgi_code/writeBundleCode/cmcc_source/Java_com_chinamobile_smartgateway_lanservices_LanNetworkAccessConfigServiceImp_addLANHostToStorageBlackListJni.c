...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_addLANHostToStorageBlackListJni
(JNIEnv *env, jobject obj, jstring hostMAC )
{
	...
	ret = joyme_cmcc_addLANHostToStorageBlackList(&response, hostMACStr);
