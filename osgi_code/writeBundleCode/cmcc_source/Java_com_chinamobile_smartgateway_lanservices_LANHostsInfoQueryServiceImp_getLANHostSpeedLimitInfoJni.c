...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_LANHostsInfoQueryServiceImp_getLANHostSpeedLimitInfoJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_getLANHostSpeedLimitInfo(response, hostMACList, hostMACNum);
