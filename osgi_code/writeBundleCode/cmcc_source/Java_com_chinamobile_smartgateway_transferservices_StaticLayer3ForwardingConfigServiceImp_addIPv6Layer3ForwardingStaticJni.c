...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_StaticLayer3ForwardingConfigServiceImp_addIPv6Layer3ForwardingStaticJni
(JNIEnv *env, jobject obj, jint index )
{
	...
	ret = joyme_cmcc_addIPv6Layer3ForwardingStatic(&response, index);
