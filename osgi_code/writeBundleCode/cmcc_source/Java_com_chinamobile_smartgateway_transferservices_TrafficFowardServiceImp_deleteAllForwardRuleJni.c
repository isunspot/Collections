...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficFowardServiceImp_deleteAllForwardRuleJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_deleteAllForwardRule(&response);
