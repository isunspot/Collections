...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_LANHostsInfoQueryServiceImp_getGatewayNameJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getGatewayName(response);
