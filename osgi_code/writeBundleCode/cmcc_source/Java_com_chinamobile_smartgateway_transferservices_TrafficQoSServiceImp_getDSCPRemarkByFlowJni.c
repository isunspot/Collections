...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficQoSServiceImp_getDSCPRemarkByFlowJni
(JNIEnv *env, jobject obj, jint flow )
{
	...
	ret = joyme_cmcc_getDSCPRemarkByFlow(&response, flow);
