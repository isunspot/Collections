...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanSecretQueryServiceImp_getWLANSSIDPasswordJni
(JNIEnv *env, jobject obj, jint ssidIndex )
{
	...
	ret = joyme_cmcc_getWLANSSIDPassword(response, ssidIndex);
