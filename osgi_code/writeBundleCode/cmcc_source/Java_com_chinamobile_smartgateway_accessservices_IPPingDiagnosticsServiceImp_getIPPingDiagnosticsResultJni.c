...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_accessservices_IPPingDiagnosticsServiceImp_getIPPingDiagnosticsResultJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getIPPingDiagnosticsResult(response);
