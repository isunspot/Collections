...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficQoSServiceImp_getSpeedByFlowJni
(JNIEnv *env, jobject obj, jint flow )
{
	...
	ret = joyme_cmcc_getSpeedByFlow(response, flow);
