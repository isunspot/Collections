...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceSecretInfoQueryServiceImp_getDevicePasswordJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDevicePassword(response);
