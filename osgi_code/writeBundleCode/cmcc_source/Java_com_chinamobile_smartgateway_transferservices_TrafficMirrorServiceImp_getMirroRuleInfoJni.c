...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficMirrorServiceImp_getMirroRuleInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getMirroRuleInfo(response);
