...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficMirrorServiceImp_deleteAllMirrorRuleJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_deleteAllMirrorRule(&response);
