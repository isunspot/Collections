...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficFowardServiceImp_getForwardRuleInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getForwardRuleInfo(response);
