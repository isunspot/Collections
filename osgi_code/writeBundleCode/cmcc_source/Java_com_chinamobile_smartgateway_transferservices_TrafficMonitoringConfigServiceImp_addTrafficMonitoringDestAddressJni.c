...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficMonitoringConfigServiceImp_addTrafficMonitoringDestAddressJni
(JNIEnv *env, jobject obj, jobjectArray destAddressList, jstring context )
{
	...
	ret = joyme_cmcc_addTrafficMonitoringDestAddress(&response, destAddressListList, destAddressListNum, contextStr);
