...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanQueryServiceImp_getWLANWPSStatusJni
(JNIEnv *env, jobject obj, jint ssidIndex )
{
	...
	ret = joyme_cmcc_getWLANWPSStatus(&response, ssidIndex);
