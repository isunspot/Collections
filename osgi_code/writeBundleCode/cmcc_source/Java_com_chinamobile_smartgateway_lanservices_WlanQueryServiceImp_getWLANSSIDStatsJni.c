...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanQueryServiceImp_getWLANSSIDStatsJni
(JNIEnv *env, jobject obj, jint ssidIndex )
{
	...
	ret = joyme_cmcc_getWLANSSIDStats(response, ssidIndex);
