...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceInfoQueryServiceImp_getDeviceUpTimeJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceUpTime(&response);
