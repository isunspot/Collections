...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getVLANBindInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getVLANBindInfo(response);
