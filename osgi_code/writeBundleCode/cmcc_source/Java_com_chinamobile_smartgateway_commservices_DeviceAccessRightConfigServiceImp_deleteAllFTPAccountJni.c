...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_deleteAllFTPAccountJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_deleteAllFTPAccount(&response);
