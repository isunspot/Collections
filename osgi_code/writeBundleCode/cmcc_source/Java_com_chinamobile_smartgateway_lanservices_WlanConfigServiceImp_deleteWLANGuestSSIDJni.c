...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanConfigServiceImp_deleteWLANGuestSSIDJni
(JNIEnv *env, jobject obj, jint guestSsidIndex )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_deleteWLANGuestSSID(&response, guestSsidIndex);
