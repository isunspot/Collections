...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_UsbServiceImp_usbRegisterJni
(JNIEnv *env, jobject obj, jstring context, jint devTypes )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_usbRegister(&response, contextStr, devTypes);
