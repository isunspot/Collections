...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficMonitoringConfigServiceImp_getTrafficMonitoringDestAddressInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getTrafficMonitoringDestAddressInfo(response);
