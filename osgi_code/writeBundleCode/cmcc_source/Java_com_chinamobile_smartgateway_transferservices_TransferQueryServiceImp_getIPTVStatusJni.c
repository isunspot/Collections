...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getIPTVStatusJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getIPTVStatus(response);
