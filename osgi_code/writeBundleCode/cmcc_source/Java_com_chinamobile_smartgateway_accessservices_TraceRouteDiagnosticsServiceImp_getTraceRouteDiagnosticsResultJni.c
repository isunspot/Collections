...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_accessservices_TraceRouteDiagnosticsServiceImp_getTraceRouteDiagnosticsResultJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getTraceRouteDiagnosticsResult(response);
