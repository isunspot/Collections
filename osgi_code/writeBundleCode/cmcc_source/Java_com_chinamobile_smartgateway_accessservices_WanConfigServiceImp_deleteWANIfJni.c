...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_accessservices_WanConfigServiceImp_deleteWANIfJni
(JNIEnv *env, jobject obj, jint wanIndex )
{
	...
	ret = joyme_cmcc_deleteWANIf(&response, wanIndex);
