...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_accessservices_AccessInfoQueryServiceImp_getWANIfStatsJni
(JNIEnv *env, jobject obj, jint wanIndex )
{
	...
	ret = joyme_cmcc_getWANIfStats(response, wanIndex);
