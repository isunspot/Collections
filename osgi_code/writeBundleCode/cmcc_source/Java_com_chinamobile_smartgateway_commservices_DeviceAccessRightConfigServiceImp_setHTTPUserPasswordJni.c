...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_setHTTPUserPasswordJni
(JNIEnv *env, jobject obj, jstring password )
{
	...
	ret = joyme_cmcc_setHTTPUserPassword(&response, passwordStr);
