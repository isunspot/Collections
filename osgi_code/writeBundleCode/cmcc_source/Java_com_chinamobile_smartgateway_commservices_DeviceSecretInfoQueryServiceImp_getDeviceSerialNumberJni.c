...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceSecretInfoQueryServiceImp_getDeviceSerialNumberJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceSerialNumber(response);
