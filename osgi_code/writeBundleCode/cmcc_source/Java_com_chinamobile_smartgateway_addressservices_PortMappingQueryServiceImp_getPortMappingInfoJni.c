...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_addressservices_PortMappingQueryServiceImp_getPortMappingInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getPortMappingInfo(response);
