...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanConfigServiceImp_setWLANHardwareSwitchJni
(JNIEnv *env, jobject obj, jstring radioType, jboolean Switch )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_setWLANHardwareSwitch(&response, radioTypeStr, Switch);
