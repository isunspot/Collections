...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getIPv6Layer3ForwardingCurrentJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getIPv6Layer3ForwardingCurrent(response);
