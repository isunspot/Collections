...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficFowardServiceImp_deleteForwardRuleJni
(JNIEnv *env, jobject obj, jint ruleNum )
{
	...
	ret = joyme_cmcc_deleteForwardRule(&response, ruleNum);
