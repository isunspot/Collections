...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficDetailProcessServiceImp_deleteAllHTTPTrafficProcessRuleJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_deleteAllHTTPTrafficProcessRule(&response);
