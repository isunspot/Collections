...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceInfoQueryServiceImp_getDeviceMACJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceMAC(response);
