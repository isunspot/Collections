...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceSecretInfoQueryServiceImp_getDeviceDefaultSSID1PasswordJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceDefaultSSID1Password(response);
