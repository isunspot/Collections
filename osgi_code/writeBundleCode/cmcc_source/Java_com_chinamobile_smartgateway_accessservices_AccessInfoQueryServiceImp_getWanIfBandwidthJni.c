...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_accessservices_AccessInfoQueryServiceImp_getWanIfBandwidthJni
(JNIEnv *env, jobject obj, jint wanIndex )
{
	int ret = 0;
	jstring reply;
	char response[4096] = "";
	...
	ret = joyme_cmcc_getWanIfBandwidth(response, wanIndex);
