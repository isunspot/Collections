...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanQueryServiceImp_getWLANSSIDInfoJni
(JNIEnv *env, jobject obj, jint ssidIndex )
{
	...
	ret = joyme_cmcc_getWLANSSIDInfo(response, ssidIndex);
