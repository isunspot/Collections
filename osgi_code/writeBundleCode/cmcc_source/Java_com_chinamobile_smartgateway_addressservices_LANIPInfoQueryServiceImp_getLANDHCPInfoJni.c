...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_addressservices_LANIPInfoQueryServiceImp_getLANDHCPInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getLANDHCPInfo(response);
