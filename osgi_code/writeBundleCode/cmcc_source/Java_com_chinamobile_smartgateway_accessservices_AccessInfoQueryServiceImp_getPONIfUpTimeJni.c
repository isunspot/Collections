...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_accessservices_AccessInfoQueryServiceImp_getPONIfUpTimeJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getPONIfUpTime(&response);
