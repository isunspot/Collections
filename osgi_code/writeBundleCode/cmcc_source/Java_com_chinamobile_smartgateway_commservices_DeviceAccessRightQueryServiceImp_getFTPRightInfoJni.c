...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightQueryServiceImp_getFTPRightInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getFTPRightInfo(response);
