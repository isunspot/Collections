...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceConfigServiceImp_setLedSwitchJni
(JNIEnv *env, jobject obj, jboolean enableState )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_setLedSwitch(&response, enableState);
