...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightQueryServiceImp_getHTTPRightInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getHTTPRightInfo(response);
