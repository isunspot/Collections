...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_addLANHostToBlackListJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_addLANHostToBlackList(&response, hostMACList, hostMACNum);
