...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_deleteLANHostFromStorageBlackListJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_deleteLANHostFromStorageBlackList(&response, hostMACList, hostMACNum);
