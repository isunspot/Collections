...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_transferservices_TransferQueryServiceImp_getLayer3ForwardingCurrentJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getLayer3ForwardingCurrent(response);
