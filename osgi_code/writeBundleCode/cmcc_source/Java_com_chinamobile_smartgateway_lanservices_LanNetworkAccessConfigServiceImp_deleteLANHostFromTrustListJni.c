...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_deleteLANHostFromTrustListJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_deleteLANHostFromTrustList(&response, hostMACList, hostMACNum);
