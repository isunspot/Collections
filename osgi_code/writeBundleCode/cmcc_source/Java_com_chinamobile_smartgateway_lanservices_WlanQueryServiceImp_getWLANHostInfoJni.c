...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanQueryServiceImp_getWLANHostInfoJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_getWLANHostInfo(response, hostMACList, hostMACNum);
