...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_addLANHostToTrustListJni
(JNIEnv *env, jobject obj, jobjectArray hostMAC )
{
	...
	ret = joyme_cmcc_addLANHostToTrustList(&response, hostMACList, hostMACNum);
