...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_deleteAllSambaAccountJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_deleteAllSambaAccount(&response);
