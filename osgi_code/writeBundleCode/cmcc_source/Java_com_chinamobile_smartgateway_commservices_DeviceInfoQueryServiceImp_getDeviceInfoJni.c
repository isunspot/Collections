...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceInfoQueryServiceImp_getDeviceInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceInfo(response);
