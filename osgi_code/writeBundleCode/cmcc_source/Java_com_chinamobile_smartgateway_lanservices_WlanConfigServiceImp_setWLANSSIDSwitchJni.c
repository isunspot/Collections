...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanConfigServiceImp_setWLANSSIDSwitchJni
(JNIEnv *env, jobject obj, jint ssidIndex, jboolean enable )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_setWLANSSIDSwitch(&response, ssidIndex, enable);
