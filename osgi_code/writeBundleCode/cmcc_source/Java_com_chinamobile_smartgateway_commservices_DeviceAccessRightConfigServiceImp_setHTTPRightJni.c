...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_setHTTPRightJni
(JNIEnv *env, jobject obj, jint right )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_setHTTPRight(&response, right);
