...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_EthQueryServiceImp_getLANEthernetInfoJni
(JNIEnv *env, jobject obj, jint portIndex )
{
	...
	ret = joyme_cmcc_getLANEthernetInfo(response, portIndex);
