...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_setSambaRightJni
(JNIEnv *env, jobject obj, jint right, jboolean anonymous )
{
	...
	ret = joyme_cmcc_setSambaRight(&response, right, anonymous);
