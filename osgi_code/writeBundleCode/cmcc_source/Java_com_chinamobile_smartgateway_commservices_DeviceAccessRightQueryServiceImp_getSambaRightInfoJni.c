...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightQueryServiceImp_getSambaRightInfoJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getSambaRightInfo(response);
