...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceSecretInfoQueryServiceImp_getDeviceDefaultWebPasswordJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getDeviceDefaultWebPassword(response);
