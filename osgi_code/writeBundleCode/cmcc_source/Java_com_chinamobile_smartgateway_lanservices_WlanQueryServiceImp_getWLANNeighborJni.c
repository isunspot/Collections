...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanQueryServiceImp_getWLANNeighborJni
(JNIEnv *env, jobject obj, jstring radioType )
{
	...
	ret = joyme_cmcc_getWLANNeighbor(response, radioTypeStr);
