...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanConfigServiceImp_addWLANGuestSSIDJni
(JNIEnv *env, jobject obj, jint guestSsidIndex )
{
	...
	ret = joyme_cmcc_addWLANGuestSSID(&response, guestSsidIndex);
