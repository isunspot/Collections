...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_UsbServiceImp_usbDataAvailableJni
(JNIEnv *env, jobject obj, jint handle )
{
	...
	ret = joyme_cmcc_usbDataAvailable(&response, handle);
