...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_WlanConfigServiceImp_setWLANRadioChannelJni
(JNIEnv *env, jobject obj, jstring radioType, jint channel )
{
	int ret = 0;
	jint response = 0;
	...
	ret = joyme_cmcc_setWLANRadioChannel(&response, radioTypeStr, channel);
