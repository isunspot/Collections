...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_lanservices_EthQueryServiceImp_getLANEthernetStatsJni
(JNIEnv *env, jobject obj, jint portIndex )
{
	int ret = 0;
	jstring reply;
	char response[4096] = "";
	...
	ret = joyme_cmcc_getLANEthernetStats(response, portIndex);
