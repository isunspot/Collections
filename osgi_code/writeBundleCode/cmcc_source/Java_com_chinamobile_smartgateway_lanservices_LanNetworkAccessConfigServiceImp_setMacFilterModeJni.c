...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_lanservices_LanNetworkAccessConfigServiceImp_setMacFilterModeJni
(JNIEnv *env, jobject obj, jint mode )
{
	...
	ret = joyme_cmcc_setMacFilterMode(&response, mode);
