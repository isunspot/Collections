...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficQoSServiceImp_addTrafficToFlowJni
(JNIEnv *env, jobject obj, jstring remoteAddress, jstring remotePort, jint flow )
{
	...
	ret = joyme_cmcc_addTrafficToFlow(&response, remoteAddressStr, remotePortStr, flow);
