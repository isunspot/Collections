...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_transferservices_TrafficMirrorServiceImp_deleteMirrorRuleJni
(JNIEnv *env, jobject obj, jint ruleNum )
{
	...
	ret = joyme_cmcc_deleteMirrorRule(&response, ruleNum);
