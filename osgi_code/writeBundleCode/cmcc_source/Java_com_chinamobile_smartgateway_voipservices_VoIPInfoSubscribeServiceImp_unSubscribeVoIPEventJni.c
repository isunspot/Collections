...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_voipservices_VoIPInfoSubscribeServiceImp_unSubscribeVoIPEventJni
(JNIEnv *env, jobject obj, jstring context, jobjectArray Event )
{
	...
	ret = joyme_cmcc_unSubscribeVoIPEvent(&response, contextStr, EventList, EventNum);
