...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_addressservices_LANIPInfoQueryServiceImp_getLANHostIPJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getLANHostIP(response);
