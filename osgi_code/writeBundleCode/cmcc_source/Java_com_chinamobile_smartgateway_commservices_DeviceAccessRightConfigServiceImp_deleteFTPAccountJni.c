...
JNIEXPORT jint JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceAccessRightConfigServiceImp_deleteFTPAccountJni
(JNIEnv *env, jobject obj, jstring username )
{
	...
	ret = joyme_cmcc_deleteFTPAccount(&response, usernameStr);
