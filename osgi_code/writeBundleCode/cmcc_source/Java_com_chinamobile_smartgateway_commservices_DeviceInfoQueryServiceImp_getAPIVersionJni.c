...
JNIEXPORT jstring JNICALL Java_com_chinamobile_smartgateway_commservices_DeviceInfoQueryServiceImp_getAPIVersionJni
(JNIEnv *env, jobject obj)
{
	...
	ret = joyme_cmcc_getAPIVersion(response);
